...
import varys.framework.network.netty.client.TransportResponseHandler;
import varys.framework.network.netty.protocol.MessageDecoder;
import varys.framework.network.netty.protocol.MessageEncoder;
import varys.framework.network.netty.server.RpcHandler;
import varys.framework.network.netty.server.TransportChannelHandler;
import varys.framework.network.netty.server.TransportRequestHandler;
 ...
 * setup Netty Channel pipelines with a {@link varys.framework.network.netty.server.TransportChannelHandler}.
 *
...
public class TransportContext {
   ...
   * has a {@link varys.framework.network.netty.server.TransportChannelHandler} to handle request or
   * response messages.
   *
